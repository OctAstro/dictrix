...
<html lang="en" class="h-100">
	...
	<body class="d-flex h-100 text-center text-white body-bg">
		<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
			<header class="mb-auto">
				<div>
					<h3 class="float-md-start mb-0">
						<span id="sitetitle1">Loading....</span>
					</h3>
			...
			<footer class="mt-auto text-white-50">
				<p>
					...
					<span
						><a class="copyright-link" href="//github.com/ImJingLan/dictum"
							>Dictum</a
						></span
					>
				</p>
		...
		<script>
			function baseinfo() {
				$.post('./api/', { type: 'siteinfo' }, function (a) {
					var b = JSON.parse(a);
					$('#sitetitle1').html(b['sitename']);
					$(document).attr('title', b['sitename'] + ' - Powered By Dictum');
				});
			}
			baseinfo();
			function dictum() {
